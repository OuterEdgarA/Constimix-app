...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-18 (commit e1abf4e). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 7.95/10 avg, hotspot health 7.95/10 (stable), worst `lib/features/enrollment/enrollment_wizard_screen.dart` at 4.09/10 · maintainability 8.54/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
