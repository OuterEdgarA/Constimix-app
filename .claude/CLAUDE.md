...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-19 (commit 237d009). Confidence: 100%.
...
- `.repowise/knowledge-graph.json` — 4 commits/90d
- `lib/features/admin/semester_admin_screen.dart` — 3 commits/90d
- `lib/core/data/mock_repository.dart` — 4 commits/90d
- `lib/l10n/app_localizations.dart` — 4 commits/90d
- `lib/features/enrollment/enrollment_wizard_screen.dart` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 7.86/10 avg, hotspot health 7.04/10 (stable), worst `lib/features/enrollment/enrollment_wizard_screen.dart` at 4.09/10 · maintainability 8.57/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `lib/features/enrollment/enrollment_wizard_screen.dart` — god class (_EnrollmentWizardScreenState) — impact −1.7
- `lib/features/enrollment/enrollment_wizard_screen.dart` — brain method (_schoolDataStep) — impact −0.5
