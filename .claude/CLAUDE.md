...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-20 (commit 17614dc). Confidence: 100%.
...
- `.repowise/knowledge-graph.json` — 7 commits/90d
- `lib/l10n/app_localizations.dart` — 7 commits/90d
- `lib/l10n/app_localizations_es.dart` — 7 commits/90d
...
### Code health
Three co-equal signals: defect risk 7.35/10 avg, hotspot health 6.11/10 (stable), worst `lib/features/enrollment/enrollment_wizard_screen.dart` at 1.0/10 · maintainability 8.54/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
