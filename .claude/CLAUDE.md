...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-18 (commit 167ef53). Confidence: 100%.
...
- `lib/core/data/mock_repository.dart` — 3 commits/90d
...
### Code health
Three co-equal signals: defect risk 7.97/10 avg, hotspot health 6.79/10 (stable), worst `lib/features/enrollment/enrollment_wizard_screen.dart` at 4.09/10 · maintainability 8.58/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
